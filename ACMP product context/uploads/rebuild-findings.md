...
| AM-06 | Rich text model | Assumed plain text (Submit inert; Notes markdown-into-plaintext; MoM deferred). | Rich vs markdown vs plain, and what is stored. | DV-04 | MAJOR |
