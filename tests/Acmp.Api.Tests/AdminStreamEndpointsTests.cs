 ...
 */
public class AdminStreamEndpointsTests : IClassFixture<AcmpWebApplicationFactory>
{
    ...
    public AdminStreamEndpointsTests(AcmpWebApplicationFactory factory) => _factory = factory.Reset();
