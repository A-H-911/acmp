...
public class DecisionTests
{
    ...
    private static Decision Drafted(DecisionOutcome outcome = DecisionOutcome.Approved,
        ...
        Decision.Draft("DECN-2026-001", Topic, meetingId: null, outcome, Rationale, alternatives: null,
    ...
    [Fact]
    public void Draft_requires_a_topic_and_a_rationale()
    {
        var noTopic = () => Decision.Draft("DECN-2026-002", Guid.Empty, null, DecisionOutcome.Approved,
            Rationale, null, null, Array.Empty<DecisionConditionInput>(), "kc", Now);
        ...
        var noRationale = () => Decision.Draft("DECN-2026-002", Topic, null, DecisionOutcome.Approved,
            null!, null, null, Array.Empty<DecisionConditionInput>(), "kc", Now);
