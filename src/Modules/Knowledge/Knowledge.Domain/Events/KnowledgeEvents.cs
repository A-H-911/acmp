...
// Knowledge document lifecycle domain events (P15d; FR-116/117). Raised by the aggregate on each state change;
// the application handlers own the audit side-effects — the module never reaches into the Audit or Notifications
// modules (ADR-0001). Payload stays small: identity + what a subscriber needs.
