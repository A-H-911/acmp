...
// The acting principal's stable subject + display-name snapshot, for attribution on edge create/resolve/
// remove and audit. Subject matches ICurrentUser.UserId (the Keycloak sub) used everywhere else.
