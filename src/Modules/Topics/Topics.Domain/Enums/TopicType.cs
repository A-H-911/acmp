...
// Canonical Topic Type taxonomy (docs/domain/topic-taxonomy.md §A, README §D) — deliberately exactly four. Type drives the
// required template, the default triage workflow, and the SLA urgency thresholds. Subtypes are tags,
// never types (docs/domain/topic-taxonomy.md §F). The design file shows three sample cards; the fourth (EnhancementInnovation)
