...
// Per-prefix, per-year allocation counter for human-readable keys (RSK-YYYY-###, README §F).
...
internal sealed class RiskKeyCounter
{
    public string Prefix { get; set; } = string.Empty;  // "RSK"
