...
// Architecture Invariant lifecycle (README §E, docs/12 §9, docs/22 §A.5): Draft → Proposed → Active →
...
// (docs/22 §A.5) — the violation surface (FR-108/109) is deferred (operator decision 2026-07-04).
