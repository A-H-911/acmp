...
const topic = (p: Partial<TopicSummary>): TopicSummary => ({ id: 'i', key: 'TOP-2026-001', title: 'Topic', type: 'ArchitectureDecision', status: 'Triage', urgency: 'Normal', scope: 'SingleStream', streams: ['identity'], ownerId: null, ownerName: null, priority: 0, timesDeferred: 0, ageDays: 1, slaBreached: false, createdAt: '2026-01-01', restricted: false, ...p });
