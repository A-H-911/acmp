...
now exist, so several `Met`-pending-P17 ACs in `docs/validation/acceptance-audit.md` can be revisited), and
**OQ-043** (docs/decisions/open-decision-register.md — RowVersion optimistic concurrency: docs/domain/data-architecture.md mandates it but NO code implements it; its
