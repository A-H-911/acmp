...
- [⚠ Tamheed writes can be LOST](tamheed-writes-can-be-lost.md) — `ok: true` proves nothing; ids get reused and overwrite earlier rows. **Verify against `tamheed-package/csv/` after every close.**
