...
|---|---|---|
| Governance maturity score | Gauge (0–100) + trend sparkline | Computed KPI-18; read model |
...
| Widget | Visual | Data source |
|---|---|---|
| Governance maturity index (KPI-18) | Gauge + component breakdown | Composite KPI read model |
...
| Link | Reference |
|---|---|
| Functional requirements | `docs/07-functional-requirements.md` §Reporting |
| KPIs | `docs/28-metrics-and-kpi-catalog.md` (KPI-## catalog) |
| Notification delivery | `docs/29-notification-strategy.md` (scheduled report notifications) |
| Data model | `docs/16-data-architecture-and-model.md` (read model tables) |
