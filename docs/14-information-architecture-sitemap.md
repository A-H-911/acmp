...
- **Depends on (canonical inputs):**
  ...
  - `docs/07-functional-requirements.md` (FR-### referenced inline via component/feature requirements)
  - `docs/04-stakeholders-and-roles.md` (role access postures)
  - `docs/10-permission-role-matrix.md` (full permission detail; this doc summarizes nav access only)
  - `adr/ADR-0006` (Tarseem integration), `ADR-0007` (Keystone), `ADR-0008` (traceability model), `ADR-0009` (immutability), `ADR-0010` (voting), `ADR-0011` (search), `ADR-0012` (frontend stack, RTL, DnD, i18n)
- **Downstream consumers:**
  - `docs/15-architecture.md` (module boundaries reflected in route groupings)
  - `docs/30-search-and-traceability.md` (global search + traceability patterns formalized here)
  - `docs/27-reporting-and-dashboards.md` (dashboard pages 70–77 are specified here; that doc provides widget detail)
  - `docs/38-epics-and-features.md` and `docs/39-user-stories-mvp.md` (user stories map to pages in this inventory)
