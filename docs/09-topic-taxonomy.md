...
- Urgency SLA thresholds → `docs/07-functional-requirements.md` FR-038 (aging indicator)
- Type → template mapping → `docs/07-functional-requirements.md` FR-041 (template selection on creation)
- Scope attribute → `docs/10-permission-role-matrix.md` (scope drives eligible voter set and notification audience)
- Source attribute → digest §3 (backlog sources; mapped here to canonical values)
- Tags → `docs/07-functional-requirements.md` FR-031–032 (backlog list/table views with tag filter)
