...
*Traceability: Pain points in this document directly drive `docs/07-functional-requirements.md` (each FR traces to ≥1 PAIN-##), `docs/38-epics-and-features.md`, and `docs/39-user-stories-mvp.md`. The MVP-critical set governs Phase 1 scope in `docs/36-roadmap.md`. Root causes and the AS-IS process they stem from are documented in `docs/02-current-state-analysis.md`.*
