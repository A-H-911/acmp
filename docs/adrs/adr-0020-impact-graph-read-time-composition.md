...
- Canonical endpoint note: `docs/domain/search-and-traceability.md`. Recorded in the P10f progress-log entry + acceptance-audit (FR-096 Met, FR-095 partial).
