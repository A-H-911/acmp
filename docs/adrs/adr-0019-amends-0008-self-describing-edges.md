...
- `docs/domain/search-and-traceability.md §2.1` — the authoritative SQL — already models edges as self-describing `(Type, Id)` pairs; matching it removes the drift with the least code.
...
- Amends ADR-0008 (`docs/adrs/adr-0008-traceability-relationship-model.md`).
- Canonical schema: `docs/domain/search-and-traceability.md §2.1`; type catalog §2.2.
