...
- Status: Accepted
- Amendment note: OIDC identity protocol in force; the *federation / external-org-Keycloak* aspect is **superseded by ADR-0015** (ACMP self-hosts Keycloak)
- Date: 2026-06-24
...
- Full role-permission matrix: `docs/domain/permission-role-matrix.md`.
