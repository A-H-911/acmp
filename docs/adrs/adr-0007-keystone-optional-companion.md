...
- Keystone's 7 mechanical quality gates (G-IDS, G-DEC-STATUS, G-REQ-SRC, G-COMPLETE, G-TRACE, G-SET, G-PROGRESS) inform ACMP's own acceptance-criteria validation in `docs/validation/acceptance-criteria.md`.
