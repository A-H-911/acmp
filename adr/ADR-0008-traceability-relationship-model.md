...
- Relationship types (initial set, not exhaustive): `ResultedIn`, `Supersedes`, `Blocks`, `DependsOn`, `ImplementedBy`, `EvidencedBy`, `AttachedTo`, `AssociatedWith`, `ConvertedTo`, `LinkedTo`. Full type vocabulary defined in `docs/30-search-and-traceability.md`.
