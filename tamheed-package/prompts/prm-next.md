...
1. ▶▶▶ **RESOLVE THE STATE; DO NOT READ THIS FILE FOR IT.** `entity_query("slice", status="Approved")`,
   ...
   **Then read these rows, and read `DEC-135` first — it is the standing rule everything else now sits
   under: `DEC-178`, `DEC-177`, `DEF-162`, `LL-081`, `PE-1093`, `PE-1092`, `PE-1091`, `PE-1090`, `DEC-176`, `PE-1089`, `DEC-175`, `DEF-161`, `PE-1088`, `PE-1087`, `DEC-174`, `DEC-173`, `LL-080`, `PE-1083`, `DEC-172`, `SC-063`, `AC-159`, `PE-1077`, `PE-1076`, `DEC-171`, `SC-062`, `DEC-170`, `DEF-160`, `PE-1074`, `DEC-169`, `DEC-168`, `DEC-167`, `PE-1072`, `PE-1071`, `DOC-071`, `DEF-159`, `DEF-158`,
